...
if(TARGET quat)
    ...
    # See if this quatlib is built as part of VRPN and whether it lives in
    # the build directory of a CMake-configured project
    if (VRPN_SOURCE_DIR)
        set(_includepaths "${VRPN_SOURCE_DIR}/quat")
    endif()
